  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost/wanderly-backend/register_user.php",
        formData
      );
